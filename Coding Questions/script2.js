...
let result1 = str1 && sr2; //&& operator returns the last truthy value or the first falsy value.
// In this case, both str1 and sr2 are truthy, so it returns the last truthy value, which is "Question".
let result2 = str1 & sr2; //& operator performs a bitwise AND operation on the ASCII values of the characters in the strings.
// Since the strings are not numbers, it will return 0 as the result of the bitwise operation.
// In this case, it will return 0 because the bitwise AND operation on the ASCII values of the characters in the strings results in 0.
console.log(result1); //Question
